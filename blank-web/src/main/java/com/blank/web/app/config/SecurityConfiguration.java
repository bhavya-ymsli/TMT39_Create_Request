...
public class SecurityConfiguration {
 ...
 @Value("*")
    ...
    public WebSecurityCustomizer webSecurityCustomizer() {
        return web -> web.ignoring().requestMatchers("/error", "/**/webjars/**","/**/resources/**","/**/ynawebjars/**","/**/public/**", "/**/static-res/**", "/monitor/**");
    }
    ...
    /**
     * oauth2-resource-custom authentication. Used for interfaces which require user information.
     */
    @Configuration
    @Profile("oauth2-resource-custom")
    @Order(SecurityProperties.BASIC_AUTH_ORDER + 2)
    protected class OAuth2ResourceCustomSecurity implements WebMvcConfigurer {
